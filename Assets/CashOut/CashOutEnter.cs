...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.HowWhatever()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIEvening.HowWhatever().KnotUITruth(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.HowWhatever().Money, 1f);
