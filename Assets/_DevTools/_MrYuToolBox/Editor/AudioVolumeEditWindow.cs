...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    void refreshAudioData()
    {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(StarkLieu.UIMusic)))
        {
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(StarkLieu.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            AudioModel model = new AudioModel();
    ...
    public void SaveJson(string Filepath)
    {
        ...
        MergeDictionaries.Exert(dic, UIAudioGroup);
        MergeDictionaries.Exert(dic, SceneAudioGroup);
