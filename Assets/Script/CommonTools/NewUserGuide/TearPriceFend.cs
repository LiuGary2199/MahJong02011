...
/// 矩形遮罩镂空
/// </summary>
public class TearPriceFend : MonoBehaviour
{
    public static TearPriceFend instance;
[UnityEngine.Serialization.FormerlySerializedAs("Hand")]    public GameObject File;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Wine(GameObject _target)
    {
        ...
        else
        {
            ...
            float Ether= 1;
            float height = 1;
            Similar[0] = new Vector3(pos.x - Ether, pos.y - height);
            Similar[1] = new Vector3(pos.x - Ether, pos.y + height);
            Similar[2] = new Vector3(pos.x + Ether, pos.y + height);
            Similar[3] = new Vector3(pos.x + Ether, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
