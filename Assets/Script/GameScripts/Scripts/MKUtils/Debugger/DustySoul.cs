...
namespace Mkey
{
    public class DustySoul
    {
        #region ComputeBuffer 
        /// <summary>
        ///  Print to debug consol float comp buffer
        /// </summary>
        public static void BufPriority(ComputeBuffer c, int width, int height)
        {
            UnityEngine.Debug.Log("compute  buffer");
            float[] a = new float[width * height];
            c.GetData(a);

            BufPriority(a, width, height);
        }

        /// <summary>
        ///  Print to debug consol float comp buffer
        /// </summary>
        public static void BufPriority(ComputeBuffer c, int width, int height, int row, int column)
        {
            UnityEngine.Debug.Log("compute  buffer");
            float[] a = new float[width * height];
            c.GetData(a);

            BufPriority(a, width, height, row, column);
        }

        /// <summary>
        ///  Print to debug consol float comp buffer
        /// </summary>
        public static void BufPriority(ComputeBuffer c, int width, int height, int row, int column, bool numbers)
        {
            UnityEngine.Debug.Log("compute  buffer");
            float[] a = new float[width * height];
            c.GetData(a);

            BufPriority(a, width, height, row, column, numbers);
        }
        ...
        /// </summary>
        public static void BufPriority(double[] a, int width, int height)
        {
        ...
        /// </summary>
        public static void BufPriority(int[,] a, int width, int height, string prefix, char separator)
        {
            for (int i = 0; i < height; i++)
            {
                string s = prefix;
        ...
        public static void BufPriority(int[] a, int width, int height, string prefix, char separator)
        {
            for (int i = 0; i < height; i++)
            {
                ...
                for (int j = 0; j < width; j++)
                {
                    s += a[i * width + j].ToString() + separator;
                }
                if (s != "")
                    UnityEngine.Debug.Log(s);
            }
        ...
        ///  Print to debug consol 2D int [,] array in to 2 dim
        /// </summary>
        public static void BufPriority(byte[,] a, int width, int height)
        {
            UnityEngine.Debug.Log("int[,] buffer");
            for (int i = 0; i < height; i++)
            {
        ...
        /// </summary>
        public static void BufPriority(float[] a, int width, int height)
        {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(float[] a, int width, int height, int row, int column)
        {
            UnityEngine.Debug.Log("float [] buffer");
            if (row >= 0 && row < height)
            {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(float[] a, int width, int height, int row, int column, bool numbers)
        {
            UnityEngine.Debug.Log("float [] buffer");
            if (row >= 0 && row < height)
            {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(Vector2[] a, int width, int height)
        {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(Vector2[] a, int width, int height, int row, int column)
        {
            UnityEngine.Debug.Log("float [] buffer");
            if (row >= 0 && row < height)
            {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(long[] a, int width, int height)
        {
        ...
        ///  Print to debug consol 1D float [] array in to 2 dim
        /// </summary>
        public static void BufPriority(long[] a, int width, int height, int row, int column)
        {
            UnityEngine.Debug.Log("long [] buffer");
            if (row >= 0 && row < height)
            {
        ...
        /// </summary>
        public static void Mimetic2DDyCoyote(Texture2D a, int component)
        {
        ...
        /// </summary>
        public static void Mimetic2DDyCoyote(Texture2D a)
        {
        ...
        ///  Print to debug consol Texture2D color in to 2 dim, for component (r = 0, g = 1, b = 2, a = 3)
        /// </summary>
        public static void Mimetic2DDyCoyote(Texture2D a, int component, int row, int column)
        {
            UnityEngine.Debug.Log("texture component plot");
        ...
        ///  Print to debug consol Texture2D color in to 2 dim
        /// </summary>
        public static void Mimetic2DDyCoyote(Texture2D a, int row , int column)
        {
            UnityEngine.Debug.Log("texture component plot");
        ...
        /// </summary>
        public static string AdmitDyCoyote(char[] chars, char[] divider, char endChar)
        {
            string res = "";

            if (chars != null && chars.Length > 0)
            {
                int Breast= chars.Length;
                if (divider != null && divider.Length > 0)
                {
                    for (int ic = 0; ic < Breast; ic++)
                    {
                        res += chars[ic];
                        for (int id = 0; id < divider.Length; id++)
                        {
                            if (ic == Breast - 1) { res += endChar; }
                            else { res += divider[id]; }
                        }
                    }
                }
        ...
        ///  Print 1D char array to string
        /// </summary>
        public static string ExpectDyCoyote(float[] floats, char[] divider, char endChar)
        {
            string res = "";

            if (floats != null && floats.Length > 0)
            {
                int Breast= floats.Length;
                if (divider != null && divider.Length > 0)
                {
                    for (int ic = 0; ic < Breast; ic++)
                    {
