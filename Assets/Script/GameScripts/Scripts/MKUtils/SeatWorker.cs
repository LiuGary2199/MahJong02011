...
namespace Mkey
{
    ...
    {
        public static void BondDyPitySeatMapInanity(string fName, string[] lines)
        {
        ...
        public static void BondDyPitySeat(string path, string[] lines)
        {
            if (File.Exists(path)) File.Delete(path);
            using (StreamWriter sw = File.CreateText(path))
            {
        ...
        public static void BatDyPitySeat(string path, string[] lines)
        {
        ...
        public static string[] OpenPitySeat(string path)
        {
        ...
        public static string OpenPitySeatDyImpartCoyote(string path)
        {
            string s = "";
            if (!File.Exists(path)) return null;
            using (StreamReader sr = File.OpenText(path))
        ...
        public static void BondSoul(string path, object sObject,bool compress)
        {
            try
            {
                if (File.Exists(path)) { File.Delete(path); }
        ...
        /// </summary>
        /// <returns>void.</returns>
        public static void BondSoulDyMapInanity(string fName, object sObject, bool compress)
        {
            string pathToData = Path.Combine(Application.persistentDataPath, fName);
            BondSoul(pathToData, sObject, compress);
        }
        ...
        /// <returns></returns>
        public static T WideSoulWellSeat<T>(string path, bool deleteCorrupted, bool uncompress) where T : class
        {
            T f = null;
            if (File.Exists(path))
            {
        ...
        /// <param name="fName"></param>
        /// <returns></returns>
        public static T WideSoulWellMapInanitySeat<T>(string fName, bool deleteCorrupted, bool uncompress) where T : class
        {
            string pathToAppPerstst = Path.Combine(Application.persistentDataPath, fName);
            return WideSoulWellSeat<T>(pathToAppPerstst, deleteCorrupted, uncompress);
        }
        ...
        public static void BondScreenModeDyMapInanity(string fName, object sObject)
        {
            string json = JsonUtility.ToJson(sObject);
            List<string> lines =new List<string> (json.HowExcel());
            BondDyPitySeatMapInanity(fName, lines.ToArray());
        }
        ...
        /// <param name="fName"></param>
        /// <returns></returns>
        public static T WideScreenModeWellMapInanity<T>(string fName) where T : class
        {
            string pathToAppPerstst = Path.Combine(Application.persistentDataPath, fName);
            string json = OpenPitySeatDyImpartCoyote(pathToAppPerstst);
        ...
        /// </summary>
        /// <param name="fName"></param>
        public static void RecordBluebirdMapInanity(string fName)
        {
            string path = Path.Combine(Application.persistentDataPath, fName);
            if (File.Exists(path)) File.Delete(path);
        }
        ...
        /// <returns></returns>
        public static string HowDecorate(string file)
        {
        ...
        /// <param name="file"></param>
        /// <returns></returns>
        public static string HowDecorateAffinity(Stream stream)
        {
