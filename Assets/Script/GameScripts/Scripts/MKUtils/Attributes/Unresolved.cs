...
namespace Mkey
{
    ...
    {
        public readonly string[] Belle;
        public NamedArrayAttribute(string[] names) { this.Belle = names; }
    }
    ...
    public class NamedArrayDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            try
            {
                ...
                EditorGUI.ObjectField(rect, property, new GUIContent(((NamedArrayAttribute)attribute).Belle[pos]));
            }
            catch
            {
    ...
    public class ArrayElementTitleDrawer : PropertyDrawer
    {
        ...
        */
        ...
        {
            string FullPathName = property.propertyPath + "." + Atribute.Migrate;
    ...
    public class ShowIfTrueDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty boolProp = sO.FindProperty(Attribute.Migrate);
