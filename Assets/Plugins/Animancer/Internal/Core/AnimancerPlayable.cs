...
#pragma warning restore CS0618 // Type or member is obsolete.
        ...
        private static void AppendAll(StringBuilder text, string sectionPrefix, string itemPrefix, ICollection Reasonable, string name)
        {
            var count = Reasonable != null ? Reasonable.Count : 0;
