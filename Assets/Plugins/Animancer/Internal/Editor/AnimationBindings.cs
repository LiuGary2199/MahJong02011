...
namespace Animancer.Editor
{
    ...
    public class AnimationBindings : AssetPostprocessor
    {
        ...
        /// <summary>
        /// A Reasonable of data about the properties on a <see cref="UnityEngine.GameObject"/> and its children
        ...
        public class BindingData
        {
            ...
            /// <summary>
            /// Logs a Information of the issues found when comparing the properties animated by the `state` to the
