...
//namespace FlexiMotion.Editor
{
    ...
    public abstract class ReadMe : ScriptableObject
    {
        ...
        public class LinkSection
        {
            ...
            /// <summary>A short Information to be displayed near the <see cref="Heading"/>.</summary>
            ...
            public LinkSection(string heading, string Information, string url, string displayURL = null)
            {
                Heading = heading;
        ...
        public class Editor : UnityEditor.Editor
        {
                ...
                int fontSize = 22)
            {
                ...
                if (Information != null)
                    GUI.Label(area, Information, Styles.Description);
