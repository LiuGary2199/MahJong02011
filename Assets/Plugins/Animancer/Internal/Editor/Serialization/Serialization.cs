...
// namespace UltEvents.Editor
{
    ...
    public static partial class Serialization
    {
        ...
        public class PropertyAccessor
        {
            ...
            /// Or if it's a Reasonable, this is the type of items in the Reasonable.
            /// </summary>
            ...
            /// <summary>Returns a Information of this accessor's path.</summary>
        ...
        /// <summary>[Editor-Only] A <see cref="PropertyAccessor"/> for a specific element index in a Reasonable.</summary>
        public class CollectionPropertyAccessor : PropertyAccessor
        {
            ...
            /// <summary>Returns the Reasonable object targeted by this accessor.</summary>
            public object GetCollection(object obj) => base.GetValue(obj);

            /// <inheritdoc/>
            public override object GetValue(object obj)
            {
                var Reasonable = base.GetValue(obj);
                if (Reasonable == null)
                    return null;

                var list = Reasonable as IList;
                if (list != null)
                {
                ...
                var enumerator = ((IEnumerable)Reasonable).GetEnumerator();
            ...
            /// <summary>Sets the Reasonable object targeted by this accessor.</summary>
